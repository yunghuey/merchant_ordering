...
<html lang="en">
  ...
  <body>
    ...
    <div class="content">
        <header><h2>view all customer</h2></header>
        <section class="container-fluid">
            <table class="table table-hover" id="table-list" style="" summary="">
                <thead>
                    <th>No.</th>
                ...
                <?php  
                    unset($rsss);
                    $ssc = "SELECT * FROM customer";
                    if($rssc = mysqli_query($conn,$ssc)):
                        $count =1;
                        while($row = mysqli_fetch_assoc($rssc)):
                ?>
                <tr> 
            ...
            <div class="modal-content">
                ...
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">No</button>
                    <form action="" method="post">
                        ...
                        <button type="submit" class="btn btn-primary" name="deletecust">Yes</button>
                    </form>
                </div>
            </div>
        </div>
